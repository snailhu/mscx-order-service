 ...
 */
@Service
public class IApiPurchaseOrNotService {
    ...
    public RtnData havePurchase(OmitSourceDto osdto, UserData userData) {
        ...
        List<SourcePackage> packageDtos = new ArrayList<>();
        packageDtos.add(sourcePackage);
        Map<String, PackageDto> packageDtoMap = iSourceServie.getSourcePackageMap(packageDtos, userData);
